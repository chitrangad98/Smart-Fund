...
const FundCard = ({ owner, title, tag, description, target, deadline, amountCollected, image, handleClick }) => {
  const remainingDays = daysLeft(deadline);
  
  return (
    <div className="sm:w-[288px] border-solid border-2 border-teal-600 w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
